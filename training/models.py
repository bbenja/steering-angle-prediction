...
# def build_swin_model_4_512():
#     model = Sequential(name="4_512")
...
#     model.add(Dense(512, activation="elu", kernel_regularizer=keras.regularizers.l2(0.005)))
...
#
#
# def build_swin_model_3_128_256():
#     model = Sequential(name="3_128_256")
#     model.add(PatchExtract(patch_size, input_shape=input_shape))
#     model.add(PatchEmbedding(num_patch_x * num_patch_y, embed_dim))
#     model.add(SwinBlock(
#         dim=embed_dim,
